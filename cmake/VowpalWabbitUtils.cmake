...
function(vw_add_library)
  ...
  if(NOT (${VW_LIB_TYPE} STREQUAL "HEADER_ONLY"))
    ...
    foreach(DEFINITION ${VW_FEATURE_COMPILE_DEFINITIONS})
      target_compile_definitions(${FULL_LIB_NAME} PRIVATE ${DEFINITION})
    endforeach()
...
function(vw_add_executable)
  ...
  # Iterate features and add compile definitions
  foreach(DEFINITION ${VW_FEATURE_COMPILE_DEFINITIONS})
    target_compile_definitions(${FULL_BIN_NAME} PRIVATE ${DEFINITION})
  endforeach()
...
function(vw_add_test_executable)
  ...
  if(CMAKE_PROJECT_NAME STREQUAL PROJECT_NAME AND BUILD_TESTING)
    ...
    # Iterate features and add compile definitions
    foreach(DEFINITION ${VW_FEATURE_COMPILE_DEFINITIONS})
      target_compile_definitions(${FULL_TEST_NAME} PRIVATE ${DEFINITION})
    endforeach()
