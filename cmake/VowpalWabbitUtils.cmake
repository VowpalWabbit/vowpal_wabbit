  ...
  if(NOT (${VW_LIB_TYPE} STREQUAL "HEADER_ONLY"))
    ...
    foreach(feature ${VW_ALL_FEATURES})
      if(VW_FEATURE_${feature}_ENABLED)
        target_compile_definitions(${FULL_LIB_NAME} PRIVATE VW_FEATURE_${feature}_ENABLED)
      endif()
    endforeach()
...
function(vw_add_executable)
  ...
  foreach(feature ${VW_ALL_FEATURES})
    if(VW_FEATURE_${feature}_ENABLED)
      target_compile_definitions(${FULL_BIN_NAME} PRIVATE VW_FEATURE_${feature}_ENABLED)
    endif()
  endforeach()
...
function(vw_add_test_executable)
  ...
  if(CMAKE_PROJECT_NAME STREQUAL PROJECT_NAME AND BUILD_TESTING)
    ...
    foreach(feature ${VW_ALL_FEATURES})
      if(VW_FEATURE_${feature}_ENABLED)
        target_compile_definitions(${FULL_TEST_NAME} PRIVATE VW_FEATURE_${feature}_ENABLED)
      endif()
    endforeach()
