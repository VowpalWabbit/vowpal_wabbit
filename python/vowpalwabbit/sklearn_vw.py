...
class VWMultiClassifier(VWClassifier):
    ...
    def predict_proba(self, X):
        ...
        array([[0.39809677, 0.30093771, 0.30096549],
            [0.41721049, 0.29138681, 0.2914027 ],
            [0.54569244, 0.22719753, 0.22711006],
            [0.54967374, 0.22520779, 0.22511844],
            [0.68573081, 0.15726991, 0.15699919],
            [0.64057422, 0.17984937, 0.1795764 ]])
        """
        return VW.predict(self, X=X)
