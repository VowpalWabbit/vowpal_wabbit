...
class vw(pylibvw.vw):
    ...
    def get_weight_from_name(self, name, namespace=""):
        ...
        """
        space_hash = self.hash_space(namespace)
        feat_hash = self.hash_feature(name, space_hash)
