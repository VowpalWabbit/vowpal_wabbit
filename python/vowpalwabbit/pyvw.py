...
class Workspace(pylibvw.vw):
    ...
    def learn(self, ec: Union["Example", List["Example"], str, List[str]], vw_to_tensorboard=None, vw_to_tensorwatch=None) -> None:
        ...
        Args:
            ...
            vw_to_tensorboard: VWtoTensorboard object. This object is used to calculate metrics and then log them for Tensorboard visualization
            vw_to_tensorwatch: VWtoTensorwatchStreamer object. This object is used to calculate metrics and then get them streamed for Tensorwatch visualization
        """
