...
g++ -std=c++11 -o ds_eventhub_client_test ds_eventhub_client_test.cc ../src/ds_eventhub_client.cc -lboost_system -lcrypto -lssl -lcpprest -lboost_unit_test_framework -DBOOST_TEST_DYN_LINK
