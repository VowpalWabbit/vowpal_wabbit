...
namespace cs_unittest
{
    ...
    public partial class RunTests : TestBase
    {
		...
		public void CommandLine_Test105()
		{
			...
			using (var vw = new VowpalWabbit("-k -d train-sets/0001.dat -f models/0001_ftrl.model --passes 10 --ftrl --ftrl_alpha 0.01 --ftrl_beta 0 --l1 2 --cache"))
			{
				foreach (var dataLine in File.ReadLines("train-sets/0001.dat"))
                {
					vw.Learn(dataLine);
				...
				VWTestHelper.AssertEqual("train-sets/ref/0001_ftrl_holdout.stderr", vw.PerformanceStatistics);
