...
vw_net_native::stream_io_writer::stream_io_writer(io_writer_vtable vtable)
 : vtable{vtable}
 {
 }

vw_net_native::stream_io_writer::~stream_io_writer()
{
  this->vtable.release();
}
...
void vw_net_native::stream_io_writer::flush()
{
  this->vtable.flush();
}
...
vw_net_native::stream_io_reader::~stream_io_reader()
{
  this->vtable.release();
}
...
void vw_net_native::stream_io_reader::reset()
{
  this->vtable.reset();
}
