    ...
    VW::experimental::api_status* status)
{
  ...
  try
  {
    ...
    {
      VW::parsers::json::read_line_json_s<true>(*workspace->vw, examples, json, length, get_example, example_pool_context);
    }
    else { VW::parsers::json::read_line_json_s<false>(*workspace->vw, examples, json, length, get_example, example_pool_context); }
