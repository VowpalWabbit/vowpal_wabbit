...
{
  workspace->vw->all_reduce_type = VW::all_reduce_type::THREAD;
...
{
  workspace->vw->all_reduce_type = VW::all_reduce_type::THREAD;
  workspace->vw->all_reduce = new VW::all_reduce_threads((VW::all_reduce_threads*)root_workspace->vw->all_reduce, total, node);
}
