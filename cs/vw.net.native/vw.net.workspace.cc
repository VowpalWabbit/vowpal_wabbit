...
vw_net_native::workspace_context* create_workspace_from_seed(VW::workspace* seed, std::string extra_arguments, trace_message_t trace_listener, void* trace_context)
{
  vw_net_native::workspace_context* context = new vw_net_native::workspace_context();
...
API vw_net_native::workspace_context* CreateWorkspaceWithSeedVwModel(vw_net_native::workspace_context* seed, char* arguments, size_t arguments_size, trace_message_t trace_listener, void* trace_context, VW::experimental::api_status* status)
{
  try
  {
...
API vw_net_native::workspace_context* CreateWorkspaceWithModelData(char* arguments, size_t arguments_size, vw_net_native::io_reader_vtable model_reader_vtable, trace_message_t trace_listener, void* trace_context, VW::experimental::api_status* status)
{
  try
  {
    io_buf model;
...
API vw_net_native::workspace_context* CreateWorkspace(char* arguments, size_t arguments_size, trace_message_t trace_listener, void* trace_context, VW::experimental::api_status* status)
{
  try
  {
    std::string arguments_str(arguments, arguments_size);
...
API vw_net_native::ERROR_CODE DeleteWorkspace(vw_net_native::workspace_context* workspace, VW::experimental::api_status* status)
{
  try
  {
...
API vw_net_native::ERROR_CODE WorkspaceReload(vw_net_native::workspace_context* workspace, char* arguments, size_t arguments_size, VW::experimental::api_status* status)
{
  try
  {
    std::string arguments_str(arguments, arguments_size);
...
API vw_net_native::ERROR_CODE WorkspaceSavePredictorToFile(vw_net_native::workspace_context* workspace, char* file_name, size_t file_name_size, VW::experimental::api_status* status)
{
  try
  {
...
API vw_net_native::ERROR_CODE WorkspaceSavePredictorToWriter(vw_net_native::workspace_context* workspace, vw_net_native::io_writer_vtable writer_vtable, VW::experimental::api_status* status)
{
  try
  {
    io_buf write_buffer;
...
API void WorkspaceGetPerformanceStatistics(vw_net_native::workspace_context* workspace, vw_net_native::performance_statistics_t* statistics)
{
  if (workspace->vw->current_pass == 0)
  {
  ...
  if (get_best_constant(*workspace->vw->loss.get(), *workspace->vw->sd, best_constant, best_constant_loss))
  {
    ...
    {
      statistics->best_constant_loss = best_constant_loss;
    }
  }
...
API vw_net_native::ERROR_CODE WorkspaceParseSingleLine(vw_net_native::workspace_context* workspace, example* ex, char* line, size_t length, VW::experimental::api_status* status)
{
  try
  {
...
API vw_net_native::ERROR_CODE WorkspacePredict(vw_net_native::workspace_context* workspace, example* ex, vw_net_native::create_prediction_callback_fn create_prediction, VW::experimental::api_status* status)
{
  try
  {
    as_singleline(workspace->vw->l)->predict(*ex);

    if (create_prediction != nullptr)
    {
      create_prediction();
    }
...
API vw_net_native::ERROR_CODE WorkspaceLearn(vw_net_native::workspace_context* workspace, example* ex, vw_net_native::create_prediction_callback_fn create_prediction, VW::experimental::api_status* status)
{
  try
  {
...
API vw_net_native::ERROR_CODE WorkspacePredictMulti(vw_net_native::workspace_context* workspace, multi_ex* ex_coll, vw_net_native::create_prediction_callback_fn create_prediction, VW::experimental::api_status* status)
{
  try
  {
...
API vw_net_native::ERROR_CODE WorkspaceLearnMulti(vw_net_native::workspace_context* workspace, multi_ex* ex_coll, vw_net_native::create_prediction_callback_fn create_prediction, VW::experimental::api_status* status)
{
  try
  {
