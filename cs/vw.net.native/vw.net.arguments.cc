...
API vw_net_native::dotnet_size_t GetInitialRegressorFilenames(vw_net_native::workspace_context* workspace, const char** filenames, vw_net_native::dotnet_size_t count)
{
  ...
  {
    filenames[i] = workspace->vw->initial_regressors[i].c_str();
  }
