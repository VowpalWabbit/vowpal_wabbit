...
/// </summary>
public
ref class VowpalWabbitPerformanceStatistics
{
public:
  /// <summary>
...
/// </remarks>
[Serializable] public ref class VowpalWabbitException : Exception
{
private:
  /// <summary>
...
/// this wrapper was created.
/// </remarks>
[Serializable] public ref class VowpalWabbitArgumentDisagreementException : VowpalWabbitException
{
public:
  /// <summary>
  /// Initializes a new instance of <see cref="VowpalWabbitException"/>.
...
#ifdef _DEBUG
[System::ComponentModel::Browsable(false)][System::ComponentModel::EditorBrowsable(
    System::ComponentModel::EditorBrowsableState::Never)] public ref class VowpalWabbitLeakTest abstract sealed
{
public:
  static void Leak() { new float[123]; }
...
#define CATCHRETHROW                                                                \
  catch (VW::vw_exception const& ex) { throw gcnew VW::VowpalWabbitException(ex); } \
  catch (std::exception const& ex) { throw gcnew System::Exception(gcnew System::String(ex.what())); }
