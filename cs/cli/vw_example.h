...
[System::Diagnostics::DebuggerDisplay("{m_weight_index}:{m_x}")] public ref struct VowpalWabbitFeature
{
private:
  feature_value m_x;
...
public:
  ...
  property feature_value X { float get(); }

  property uint64_t FeatureIndex { uint64_t get(); }

  property uint64_t WeightIndex { uint64_t get(); }

  property float Weight { float get(); }

  property float AuditWeight { float get(); }
...
[System::Diagnostics::DebuggerDisplay("{Index} = '{(char)Index}'")] public ref struct VowpalWabbitNamespace
    : public IEnumerable<VowpalWabbitFeature ^>
{
private:
  ...
  private:
    ...
    internal : FeatureEnumerator(VowpalWabbitExample ^ example, features* features);
    ~FeatureEnumerator();

    property System::Object ^
        IEnumeratorCurrent { virtual System::Object ^ get() sealed = System::Collections::IEnumerator::Current::get; }
    ...
    property VowpalWabbitFeature ^ Current { virtual VowpalWabbitFeature ^ get(); }
  };
  ...
  property System::Collections::IEnumerator ^
      ...
      public : VowpalWabbitNamespace(VowpalWabbitExample ^ m_example, namespace_index ns, features* features);
  ~VowpalWabbitNamespace();

  property namespace_index Index { namespace_index get(); }
...
/// </remarks>
[System::Diagnostics::DebuggerDisplay("{m_example}: '{m_string}'")] public ref class VowpalWabbitExample
    : public IEnumerable<VowpalWabbitNamespace ^>
{
private:
  /// <summary>
  ...
  private:
    ...
    property VowpalWabbitNamespace ^ Current { virtual VowpalWabbitNamespace ^ get(); }
  };
...
public:
  ...
  /// Initializes a new instance of <see cref="VowpalWabbitExample"/>.
  /// </summary>
  /// <param name="owner">The parent instance. Examples cannot be shared between <see cref="IVowpalWabbitExamplePool"/>
  /// instances.</param> <param name="example">The inner example this instance wraps.</param>
  ...
  /// </summary>
  property VowpalWabbitExample ^
      InnerExample { VowpalWabbitExample ^ get(); }

      /// <summary>
      /// The owner of this example.
      /// </summary>
      property IVowpalWabbitExamplePool ^
      Owner { IVowpalWabbitExamplePool ^ get(); }
  ...
  property System::Collections::IEnumerator ^
      ...
      virtual IEnumerator<VowpalWabbitNamespace ^> ^
      GetEnumerator();

  property size_t NumberOfFeatures { size_t get(); }
