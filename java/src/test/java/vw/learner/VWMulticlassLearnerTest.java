...
public class VWMulticlassLearnerTest extends VWTestHelper {
    ...
    public void testContextualBandits() throws IOException {
        ...
        MulticlassLearner vw = VowpalWabbitLearners.create("--quiet --cb 4 -f " + cbModel);
        ...
        vw = VowpalWabbitLearners.create("--quiet -t -i " + cbModel);
    ...
    public void csoaa() throws IOException {
        ...
        MulticlassLearner vw = VowpalWabbitLearners.create("--quiet --csoaa 3 -f " + model);
        ...
        vw = VowpalWabbitLearners.create("--quiet -t -i " + model);
