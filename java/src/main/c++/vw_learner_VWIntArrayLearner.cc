...
{ return base_predict<jintArray, jintArray (example*, JNIEnv*)>(env, example_string, learn, vwPtr, predictorPtr);
}
...
{ return base_predict<jintArray, jintArray (example*, JNIEnv*)>(env, example_strings, learn, vwPtr, predictorPtr);
}
