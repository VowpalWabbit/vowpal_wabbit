...
{ return base_predict<jfloat, jfloat (example*, JNIEnv*)>(env, obj, example_string, learn, vwPtr, predictorPtr);
}
...
{ return base_predict<jfloat, jfloat (example*, JNIEnv*)>(env, obj, example_strings, learn, vwPtr, predictorPtr);
}
