...
{ return base_predict<jint, jint (example*, JNIEnv*)>(env, obj, example_string, learn, vwPtr, predictorPtr);
}
...
{ return base_predict<jint, jint (example*, JNIEnv*)>(env, obj, example_strings, learn, vwPtr, predictorPtr);
}
