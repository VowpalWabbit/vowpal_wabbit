...
if(RAPIDJSON_SYS_DEP)
  ...
  # Some RapidJSON packages only export include variables and no CMake target.
  if(NOT TARGET RapidJSON)
    if(NOT DEFINED RapidJSON_INCLUDE_DIRS AND NOT DEFINED RAPIDJSON_INCLUDE_DIRS)
      message(FATAL_ERROR "RapidJSON package did not provide target or include directories")
    endif()
    add_library(RapidJSON INTERFACE)
  endif()
  target_include_directories(RapidJSON SYSTEM INTERFACE ${RapidJSON_INCLUDE_DIRS} ${RAPIDJSON_INCLUDE_DIRS})
else()
  add_library(RapidJSON INTERFACE)
...
if(VW_EIGEN_SYS_DEP)
  ...
  if(CMAKE_VERSION VERSION_GREATER_EQUAL "3.19")
    find_package(Eigen3 3.4.0...6 CONFIG QUIET)
    if(Eigen3_FOUND)
