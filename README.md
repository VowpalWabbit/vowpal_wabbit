...
## Why Vowpal Wabbit?
Vowpal Wabbit is a machine learning system which pushes the frontier with techniques such as online, hashing, allreduce, reductions, learning2search, active, and interactive learning. Reinforcement learning is focused on with several contextual bandit algorithms implemented. Vowpal Wabbit is a great choice for implementing and maturing state of the art algorithms with performance in mind.
