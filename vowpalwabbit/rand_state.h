...
public:
   ...
   */
  float get_and_update_random() { return merand48(_random_state); }
   ...
   */
  float get_and_update_gaussian() { return merand48_boxmuller(_random_state); }
   ...
   * @return float
   */
  float get_random() const { return merand48_noadvance(_random_state); }
