...
TEST(explore, sample_continuous_action)
{
...
TEST(explore, sample_continuous_action_statistical)
{
...
TEST(explore, sample_after_nomalizing_basic)
{
...
TEST(explore, sample_after_nomalizing_degenerate)
{
...
TEST(explore, epsilon_greedy_top_action_out_of_bounds)
{
  std::vector<float> pdf(4);
...
TEST(explore, epsilon_greedy_bad_range)
{
...
TEST(explore, softmax_imbalanced)
{
...
TEST(explore, softmax_imbalanced2)
{
...
TEST(explore, softmax_bad_range)
{
...
TEST(explore, enforce_minimum_probability)
{
...
TEST(explore, enforce_minimum_probability_no_zeros)
{
...
TEST(explore, enforce_minimum_probability_all_zeros_and_dont_consider)
{
...
TEST(explore, enforce_minimum_probability_all_zeros_and_consider)
{
  std::vector<float> pdf = {0.f, 0.f, 0.f};
...
TEST(explore, enforce_minimum_probability_equal_to_amt)
{
...
TEST(explore, enforce_minimum_probability_uniform)
{
...
TEST(explore, enforce_minimum_probability_uniform_no_zeros)
{
  std::vector<float> pdf = {0.9f, 0.1f, 0};
...
TEST(explore, enforce_minimum_probability_bad_range)
{
  std::vector<float> pdf;
  float x;
...
TEST(explore, enforce_minimum_probability_uniform_1)
{
...
TEST(explore, enforce_minimum_probability_uniform_2)
{
...
TEST(explore, enforce_minimum_probability_uniform_unsorted)
{
...
TEST(explore, enforce_minimum_probability_old_impl_bug_incl_zero)
{
...
TEST(explore, enforce_minimum_probability_old_impl_bug_dont_incl_zero)
{
  std::vector<float> pdf = {0.89f, 0.11f, 0.0f};
...
TEST(explore, enforce_minimum_probability_zero_epsilon)
{
  std::vector<float> pdf = {0.89f, 0.11f, 0.0f};
...
TEST(explore, sampling_rank_bad_range)
{
  std::vector<float> pdf;
  std::vector<float> scores;
...
TEST(explore, sampling_rank_zero_pdf)
{
  std::vector<float> pdf = {0.f, 0.f, 0.f};
...
TEST(explore, sampling_rank_negative_pdf)
{
...
TEST(explore, mix_with_uniform_test)
{
...
TEST(explore, mix_with_uniform_floats_test)
{
...
TEST(explore, mix_with_uniform_test_2)
{
  VW::action_scores probs;
...
TEST(explore, mix_with_uniform_test_3)
{
  VW::action_scores probs;
