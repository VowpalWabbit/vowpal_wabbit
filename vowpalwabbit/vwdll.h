...
// these are optional  since other compilers may not have wide to narrow char
// libarray facilities built in.
#ifdef WIN32
#define USE_CODECVT
#endif
...
VW_DLL_MEMBER VW_HANDLE VW_CALLING_CONV
VW_InitializeEscaped(const char16_t *pstrArgs);
#endif
VW_DLL_MEMBER VW_HANDLE VW_CALLING_CONV VW_InitializeA(const char *pstrArgs);
VW_DLL_MEMBER VW_HANDLE VW_CALLING_CONV
VW_InitializeEscapedA(const char *pstrArgs);
...
VW_DLL_MEMBER VW_FEATURE_SPACE VW_CALLING_CONV
VW_InitializeFeatureSpaces(size_t len);
VW_DLL_MEMBER VW_FEATURE_SPACE VW_CALLING_CONV
VW_GetFeatureSpace(VW_FEATURE_SPACE first, size_t index);
VW_DLL_MEMBER VW_FEATURE_SPACE VW_CALLING_CONV
VW_ExportExample(VW_HANDLE handle, VW_EXAMPLE e, size_t *plen);
VW_DLL_MEMBER void VW_CALLING_CONV
VW_ReleaseFeatureSpace(VW_FEATURE_SPACE features, size_t len);
#ifdef USE_CODECVT
VW_DLL_MEMBER VW_EXAMPLE VW_CALLING_CONV VW_ReadExample(VW_HANDLE handle,
                                                        const char16_t *line);
#endif
...
VW_DLL_MEMBER void VW_CALLING_CONV
VW_InitFeatures(VW_FEATURE_SPACE feature_space, size_t features_count);
VW_DLL_MEMBER VW_FEATURE VW_CALLING_CONV
VW_GetFeature(VW_FEATURE_SPACE feature_space, size_t index);
VW_DLL_MEMBER void VW_CALLING_CONV VW_SetFeature(VW_FEATURE feature,
                                                 size_t index,
                                                 size_t feature_hash,
                                                 float value);
...
#ifdef USE_CODECVT
VW_DLL_MEMBER size_t VW_CALLING_CONV VW_HashSpace(VW_HANDLE handle,
                                                  const char16_t *s);
VW_DLL_MEMBER size_t VW_CALLING_CONV VW_HashSpaceStatic(const char16_t *s,
                                                        const char16_t *h);
#endif
...
VW_DLL_MEMBER size_t VW_CALLING_CONV VW_HashSpaceStaticA(const char *s,
                                                         const char *h);
#ifdef USE_CODECVT
VW_DLL_MEMBER size_t VW_CALLING_CONV VW_HashFeature(VW_HANDLE handle,
                                                    const char16_t *s,
                                                    size_t u);
...
VW_DLL_MEMBER float VW_CALLING_CONV VW_PredictCostSensitive(VW_HANDLE handle,
                                                            VW_EXAMPLE e);
// deprecated. Please use either VW_ReadExample for parsing, or VW_ImportExample
// for example construction
VW_DLL_MEMBER void VW_CALLING_CONV VW_AddLabel(VW_EXAMPLE e, float label,
                                               float weight, float base);
// deprecated. Please use either VW_ReadExample for parsing, or VW_ImportExample
// for example construction
...
VW_DLL_MEMBER void VW_CALLING_CONV VW_Set_Weight(VW_HANDLE handle, size_t index,
