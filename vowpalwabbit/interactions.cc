...
std::vector<std::string> expand_interactions(const vector<string> &vec,
...
int64_t fast_factorial[] = {1,
                            ...
                            121645100408832000,
                            2432902008176640000};
const size_t size_fast_factorial =
