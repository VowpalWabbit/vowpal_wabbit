...
//      {
//        interactions.push_back({*jt, *it});
//        interactions.active_interactions.insert({*jt, *it});
//      }
//    }
//  }
//
//  std::sort(interactions.begin(), interactions.end(), sort_interactions_comparator);
//}
