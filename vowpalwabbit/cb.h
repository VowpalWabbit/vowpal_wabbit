...
struct cb_class {
  ...
  float probability; // new for bandit setting, specifies the probability the
                     // data collection policy chose this class
...
void print_update(vw &all, bool is_test, example &ec,
                  std::vector<example *> *ec_seq, bool action_scores);
} // namespace CB
