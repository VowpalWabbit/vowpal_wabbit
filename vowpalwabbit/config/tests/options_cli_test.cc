...
TEST(options_cli_tests, typed_options_parsing)
{
...
TEST(options_cli_tests, typed_option_collection_parsing)
{
...
TEST(options_cli_tests, typed_option_collection_parsing_equals_long_option)
{
...
TEST(options_cli_tests, typed_option_collection_parsing_short_option_attached_value)
{
...
TEST(options_cli_tests, list_consume_until_option_like)
{
...
TEST(options_cli_tests, list_no_tokens)
{
...
TEST(options_cli_tests, type_conversion_failure)
{
...
TEST(options_cli_tests, order_of_parsing)
{
  {
...
TEST(options_cli_tests, bool_implicit_and_explicit_options)
{
...
TEST(options_cli_tests, option_missing_required_value)
{
  auto options = vwtest::make_args("--str_opt");
...
TEST(options_cli_tests, incorrect_option_type_str_for_int)
{
...
TEST(options_cli_tests, multiple_locations_one_option)
{
...
TEST(options_cli_tests, duplicate_option_clash)
{
...
TEST(options_cli_tests, mismatched_values_duplicate_command_line)
{
...
TEST(options_cli_tests, get_positional_tokens)
{
...
TEST(options_cli_tests, get_positional_tokens_with_terminator)
{
...
TEST(options_cli_tests, matching_values_duplicate_command_line)
{
...
TEST(options_cli_tests, nonmatching_values_command_line)
{
...
TEST(options_cli_tests, nonmatching_values_command_line_with_override)
{
  auto options = vwtest::make_args("--int_opt", "3", "--int_opt", "4");
...
TEST(options_cli_tests, add_two_groups)
{
...
TEST(options_cli_tests, was_supplied_test)
{
  auto options = vwtest::make_args("--int_opt", "3", "--str_opt", "test");
...
TEST(options_cli_tests, kept_command_line)
{
...
TEST(options_cli_tests, unregistered_options)
{
  auto options = vwtest::make_args("--int_opt", "3", "--str_opt", "test");
...
TEST(options_cli_tests, check_necessary)
{
  auto options = vwtest::make_args("--int_opt", "3", "--str_opt", "test", "--other_bool_opt");
...
TEST(options_cli_tests, check_missing_necessary)
{
...
TEST(options_cli_tests, check_multiple_necessary_and_short_name)
{
...
TEST(options_cli_tests, check_multiple_necessary_one_missing)
{
...
TEST(options_cli_tests, check_was_supplied_common_prefix_before)
{
