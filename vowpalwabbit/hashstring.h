...
STD14_CONSTEXPR inline uint64_t hashall(substring s, uint64_t h) { return uniform_hash((unsigned char*)s.begin, s.end - s.begin, h); }

STD14_CONSTEXPR inline uint64_t hashstring(substring s, uint64_t h)
{
