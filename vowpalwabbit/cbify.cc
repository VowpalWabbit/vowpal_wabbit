...
base_learner* cbify_setup(setup_base_fn setup_base_fn, options_i& options, vw& all)
{
...
base_learner* cbifyldf_setup(setup_base_fn setup_base_fn, options_i& options, vw& all)
{
  auto data = scoped_calloc_or_throw<cbify>();
