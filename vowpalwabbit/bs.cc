...
base_learner* bs_setup(VW::setup_base_fn& setup_base_fn, options_i& options, vw& all)
{
  ...
  learner<bs, example>& l = init_learner(data, as_singleline(setup_base_fn(options, all)), predict_or_learn<true>,
