...
base_learner* csoaa_setup(setup_base_fn setup_base_fn, options_i& options, vw& all)
{
...
base_learner* csldf_setup(setup_base_fn setup_base_fn, options_i& options, vw& all)
{
