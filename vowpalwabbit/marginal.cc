...
VW::LEARNER::base_learner* marginal_setup(VW::setup_base_fn& setup_base_fn, options_i& options, vw& all)
{
  ...
  VW::LEARNER::learner<MARGINAL::data, example>& ret = init_learner(d, as_singleline(setup_base_fn(options, all)),
