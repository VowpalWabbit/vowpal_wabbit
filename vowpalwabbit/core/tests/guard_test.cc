...
TEST(guard_tests, swap_guard_execute_on_scope_end)
{
...
TEST(guard_tests, swap_guard_execute_on_scope_end_no_copy)
{
...
TEST(guard_tests, swap_guard_cancel)
{
  int original_location = 1;
  int location_to_swap = 99999;
...
TEST(guard_tests, swap_guard_explicit_force_swap)
{
  int original_location = 1;
  int location_to_swap = 99999;
...
TEST(guard_tests, swap_guard_execute_on_scope_end_swap_pointers)
{
...
TEST(guard_tests, swap_guard_execute_temp_value)
{
  int original_location = 1;
...
TEST(guard_tests, swap_guard_execute_temp_value_no_copy)
{
  non_copyable_class original_location(1);
...
TEST(guard_tests, swap_guard_unique_ptr)
{
...
TEST(guard_tests, stash_guard_execute_on_scope_end)
{
...
TEST(guard_tests, stash_guard_used_default_ctor)
{
