...
TEST(thread_pool, thread_pool_with_zero_threads)
{
...
TEST(thread_pool, thread_pool_with_more_threads_than_tasks)
{
  size_t outer_vector_size = 10;
  size_t inner_vectors_size = 10;
...
TEST(thread_pool, thread_pool_with_less_threads_than_tasks)
{
  size_t outer_vector_size = 10;
  size_t inner_vectors_size = 10;
