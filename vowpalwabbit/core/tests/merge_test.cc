...
TEST(Merge, MergeCbModel)
{
  ...
  EXPECT_EQ(vw_merged_cb_adf->get_gen_cs().per_model_state[0].event_sum,
      vw1_cb_adf->get_gen_cs().per_model_state[0].event_sum + vw2_cb_adf->get_gen_cs().per_model_state[0].event_sum);
  EXPECT_EQ(vw_merged_cb_adf->get_gen_cs().per_model_state[0].action_sum,
      vw1_cb_adf->get_gen_cs().per_model_state[0].action_sum + vw2_cb_adf->get_gen_cs().per_model_state[0].action_sum);
}
...
TEST(Merge, MergeCbModelDelta)
{
  ...
  EXPECT_EQ(delta_merged_cb_adf->get_gen_cs().per_model_state[0].event_sum,
      vw1_cb_adf->get_gen_cs().per_model_state[0].event_sum + vw2_cb_adf->get_gen_cs().per_model_state[0].event_sum - vw_base_cb_adf->get_gen_cs().per_model_state[0].event_sum);
  EXPECT_EQ(delta_merged_cb_adf->get_gen_cs().per_model_state[0].action_sum,
      vw1_cb_adf->get_gen_cs().per_model_state[0].action_sum + vw2_cb_adf->get_gen_cs().per_model_state[0].action_sum -
          vw_base_cb_adf->get_gen_cs().per_model_state[0].action_sum);
  ...
  EXPECT_EQ(delta_merged_cb_adf->get_gen_cs().per_model_state[0].event_sum, model_merged_cb_adf->get_gen_cs().per_model_state[0].event_sum);
  EXPECT_EQ(delta_merged_cb_adf->get_gen_cs().per_model_state[0].action_sum, model_merged_cb_adf->get_gen_cs().per_model_state[0].action_sum);
}
