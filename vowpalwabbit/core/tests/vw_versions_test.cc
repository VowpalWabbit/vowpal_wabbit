...
TEST(version, verify_vw_versions)
{
...
TEST(version, verify_vw_version_operators)
{
...
TEST(version, verify_vw_version_tostring)
{
...
TEST(version, verify_vw_version_fromstring)
{
  EXPECT_TRUE((VW::version_struct{0, 0, 0} == VW::version_struct{"0.0.0"}));
  EXPECT_TRUE((VW::version_struct{1, 1, 1} == VW::version_struct{"1.1.1"}));
