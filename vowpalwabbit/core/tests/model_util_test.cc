...
TEST(model_util, unique_ptr_nullptr)
{
...
TEST(model_util, unique_ptr_overwrites_value_withnullptr)
{
  auto backing_buffer = std::make_shared<std::vector<char>>();
  VW::io_buf write_buffer;
  write_buffer.add_file(VW::io::create_vector_writer(backing_buffer));
...
TEST(model_util, unique_ptr_simple_value)
{
  auto backing_buffer = std::make_shared<std::vector<char>>();
  VW::io_buf write_buffer;
  write_buffer.add_file(VW::io::create_vector_writer(backing_buffer));
...
TEST(model_util, unique_ptr_string)
{
  auto backing_buffer = std::make_shared<std::vector<char>>();
  VW::io_buf write_buffer;
  write_buffer.add_file(VW::io::create_vector_writer(backing_buffer));
...
TEST(model_util, vector_unique_ptr_string)
{
  auto backing_buffer = std::make_shared<std::vector<char>>();
  VW::io_buf write_buffer;
  write_buffer.add_file(VW::io::create_vector_writer(backing_buffer));
