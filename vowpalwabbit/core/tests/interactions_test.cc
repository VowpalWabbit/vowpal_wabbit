...
TEST(Interactions, extentVsCharInteractionsWildcard) { doInteractionFeatureCountTest(true, false, true, True); }
TEST(Interactions, ExtentVsCharInteractionsCubicWildcard)
{
