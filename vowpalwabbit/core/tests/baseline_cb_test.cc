...
TEST(baseline_cb, baseline_cb_baseline_performs_badly)
{
...
TEST(baseline_cb, baseline_cb_baseline_takes_over_policy)
{
  using namespace test_helpers;
...
TEST(baseline_cb, baseline_cb_save_load_test)
{
  using namespace test_helpers;
