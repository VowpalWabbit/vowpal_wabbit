...
TEST(offset_tree, offset_tree_learn_basic)
{
  // Setup a test harness base reduction
...
TEST(offset_tree, offset_tree_predict)
{
  // 0 node tree
  predict_test_helper({{}}, {});
  // 1 node tree
...
TEST(offset_tree, build_min_depth_tree_11)
{
...
TEST(offset_tree, build_min_depth_tree_4)
{
  VW::reductions::offset_tree::min_depth_binary_tree tree;
  tree.build_tree(4);
...
TEST(offset_tree, build_min_depth_tree_3)
{
  VW::reductions::offset_tree::min_depth_binary_tree tree;
  tree.build_tree(3);
...
TEST(offset_tree, build_min_depth_tree_1)
{
  VW::reductions::offset_tree::min_depth_binary_tree tree;
  tree.build_tree(1);
