...
TEST(cats_tree, otc_algo_learn_1_action_till_root)
{
...
TEST(cats_tree, otc_algo_learn_1_action)
{
  reduction_test_harness* pharness = nullptr;
...
TEST(cats_tree, otc_algo_learn_2_action_siblings)
{
  VW::example ec;
  ec.ft_offset = 0;
  ec.debug_current_reduction_depth = 0;
...
TEST(cats_tree, otc_algo_learn_2_action_notSiblings)
{
  VW::example ec;
  ec.ft_offset = 0;
  ec.debug_current_reduction_depth = 0;
...
TEST(cats_tree, otc_algo_learn_2_action_notSiblings_bandwidth_1)
{
  VW::example ec;
  ec.ft_offset = 0;
  ec.debug_current_reduction_depth = 0;
...
TEST(cats_tree, otc_algo_learn_2_action_separate)
{
  VW::example ec;
  ec.ft_offset = 0;
  ec.debug_current_reduction_depth = 0;
...
TEST(cats_tree, otc_algo_learn_2_action_separate_2)
{
  VW::example ec;
  ec.ft_offset = 0;
  ec.debug_current_reduction_depth = 0;
...
TEST(cats_tree, otc_algo_learn_2_action_separate_bandwidth_2)
{
  VW::example ec;
  ec.ft_offset = 0;
  ec.debug_current_reduction_depth = 0;
...
TEST(cats_tree, otc_algo_learn_2_action_separate_2_bandwidth_2)
{
  VW::example ec;
  ec.ft_offset = 0;
  ec.debug_current_reduction_depth = 0;
...
TEST(cats_tree, otc_algo_learn_2_action_separate_bandwidth_1_asym)
{
  VW::example ec;
  ec.ft_offset = 0;
  ec.debug_current_reduction_depth = 0;
...
TEST(cats_tree, offset_tree_cont_predict)
{
  // 0 node tree
...
TEST(cats_tree, build_min_depth_tree_cont_5)
{
...
TEST(cats_tree, build_min_depth_tree_cont_1)
{
  VW::reductions::cats::min_depth_binary_tree tree;
  tree.build_tree(1, 0);
