...
TEST(feature_group, unique_feature_group_test)
{
  VW::features fs;
  fs.push_back(1.f, 1);
  fs.push_back(1.f, 2);
...
TEST(feature_group, flatten_then_unflatten_namespace_extents_test)
{
...
TEST(feature_group, sort_feature_group_test)
{
  VW::features fs;
  fs.push_back(1.f, 1);
  fs.push_back(1.f, 25);
...
TEST(feature_group, iterate_extents_test)
{
