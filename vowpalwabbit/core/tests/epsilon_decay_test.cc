...
TEST(epsilon_decay, init_w_iterations)
{
...
TEST(epsilon_decay, champ_change_w_iterations)
{
...
TEST(epsilon_decay, update_count_w_iterations)
{
...
TEST(epsilon_decay, save_load_w_iterations)
{
...
TEST(epsilon_decay, score_bounds_unit)
{
...
TEST(epsilon_decay, horizon_bounds_unit)
{
  // Initialize epsilon_decay_data class with 5 models
  uint64_t num_models = 5;
  uint32_t wpp = 8;
