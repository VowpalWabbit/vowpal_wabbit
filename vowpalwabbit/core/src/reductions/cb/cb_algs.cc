...
std::shared_ptr<VW::LEARNER::learner> VW::reductions::cb_algs_setup(VW::setup_base_i& stack_builder)
{
  ...
  if (eval) { all.parser_runtime.example_parser->lbl_parser = VW::cb_eval_label_parser_global; }
  else { all.parser_runtime.example_parser->lbl_parser = VW::cb_label_parser_global; }
