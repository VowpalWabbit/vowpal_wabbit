...
double countable_discrete_base::get_s() { THROW("Unimplemented"); }

double countable_discrete_base::get_v(double) { THROW("Unimplemented"); }
...
double robust_mixture::get_log_weight(double j) { return log_scale_fac + log_xi_m1 - (1 + j) * log_xi; }

double robust_mixture::get_log_remaining_weight(double j) { return log_scale_fac - j * log_xi; }

double robust_mixture::get_s() { return gt.get_s(); }

double robust_mixture::get_v(double lam_sqrt_tp1) { return gt.get_v(lam_sqrt_tp1); }
