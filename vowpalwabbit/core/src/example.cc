...
void VW::add_example_namespace(VW::example& ec, VW::namespace_index ns, const features& fs)
{
...
void VW::add_example_namespaces_from_example(VW::example& target, const VW::example& source)
{
...
void VW::del_example_namespaces_from_example(VW::example& target, const VW::example& source)
{
