...
size_t write_model_field(
    io_buf& io, const VW::incremental_f_sum& ifs, const std::string& upstream_name, bool text)
{
  size_t bytes = 0;
...
size_t write_model_field(
    io_buf& io, const VW::confidence_sequence& im, const std::string& upstream_name, bool text)
{
  size_t bytes = 0;
