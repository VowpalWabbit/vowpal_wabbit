...
template <class DataT, class S, void (*FuncT)(DataT&, float, S), class WeightsT>
    ...
    namespace_interactions& interactions, bool permutations, example_predict& ec, DataT& dat)
{
  ...
  generate_interactions<DataT, S, FuncT, WeightsT>(interactions, permutations, ec, dat, weights);
}
