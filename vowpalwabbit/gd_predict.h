...
namespace GD
{
  ...
  inline void foreach_feature(W& weights, bool ignore_some_linear, bool ignore_linear[256], v_array<v_string>& interactions, bool permutations, example_predict& ec, R& dat)
  {
    ...
    INTERACTIONS::generate_interactions<R, S, T, W>(interactions, permutations, ec, dat, weights);
  }
