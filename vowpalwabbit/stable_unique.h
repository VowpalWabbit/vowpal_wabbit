...
// Performs unique operation over collection without requiring the collection to
// be sorted first.
// Returns pointer to first element after unique elements to erase from until
// end of collection.
