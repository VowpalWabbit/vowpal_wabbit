...
// depending on oracle design. Note that this does not excplicitly take champion
// as argument, but it has access to champ and should use that in future
// implementations.
void config_manager::exclusion_configs_oracle()
{
  if (new_namespaces.empty()) { return; }
