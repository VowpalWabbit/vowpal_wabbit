...
VW::LEARNER::base_learner* expreplay_setup(VW::setup_base_fn& setup_base_fn, VW::config::options_i& options, vw& all)
{
  ...
  er->base = VW::LEARNER::as_singleline(setup_base_fn(options, all));
