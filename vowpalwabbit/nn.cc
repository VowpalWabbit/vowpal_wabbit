...
void finish_setup(nn& n, vw& all)
{
  ...
  n.outputweight._reduction_features.get<simple_label_reduction_features>().initial = 0.f;
...
void predict_or_learn_multi(nn& n, single_learner& base, example& ec)
{
  ...
  CONVERSE:  // That's right, I'm using goto.  So sue me.
    ...
    else
    {
      ...
      n.output_layer._reduction_features.get<simple_label_reduction_features>().initial =
          ec._reduction_features.get<simple_label_reduction_features>().initial;
