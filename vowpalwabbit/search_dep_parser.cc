...
//        srn.loss((gold_heads[stack.last()] != heads[stack.last()]) + (gold_tags[stack.last()] != t_id));
  ...
  void my_initialize(Search::search& srn, example *base_ex) {
    ...
    fs_idx_map["s1"]=1, fs_idx_map["s2"]=2, fs_idx_map["s3"]=3;
    fs_idx_map["b1"]=4, fs_idx_map["b2"]=5, fs_idx_map["b3"]=6;
    fs_idx_map["sl1"]=7, fs_idx_map["sl2"]=8, fs_idx_map["sr1"]=9;
    fs_idx_map["sr2"]=10, fs_idx_map["bl1"]=11, fs_idx_map["bl2"]=12;
	fs_idx_map["s21"]=13;
