...
class predictor
{
 public:
  ...
  predictor &add_condition_range(ptag hi,
      ptag count,
      char name0);  // add (hi,name0), (hi-1,name0+1), ..., (h-count,name0+count)
  predictor &set_condition_range(ptag hi,
      ptag count,
...
const char* opt_name, bool default_to_cmdline, bool(*equal)(T,T), const char*
mismatch_error_string, const char* required_error_string)
...
// opt_name, bool default_to_cmdline, const char* mismatch_error_string);
