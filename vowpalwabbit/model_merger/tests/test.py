...
subprocess.check_call([vw_bin, "--driver_output_off", f"--data={this_dir/'data'/'0002.part1.vw'}", f"--final_regressor={this_dir / 'model1.vw'}"])
subprocess.check_call([vw_bin, "--driver_output_off", f"--data={this_dir/'data'/'0002.part2.vw'}", f"--final_regressor={this_dir / 'model2.vw'}"])
