...
VW::LEARNER::base_learner* interact_setup(VW::setup_base_fn& setup_base_fn, options_i& options, vw& all)
{
  std::string s;
  ...
  l = &VW::LEARNER::init_learner(data, as_singleline(setup_base_fn(options, all)), predict_or_learn<true, true>,
