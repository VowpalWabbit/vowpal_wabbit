...
base_learner* mf_setup(VW::setup_base_fn& setup_base_fn, options_i& options, vw& all)
{
  ...
  learner<mf, example>& l = init_learner(data, as_singleline(setup_base_fn(options, all)), learn, predict<false>,
