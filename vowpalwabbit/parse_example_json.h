...
template <bool audit>
int read_features_json(vw* all, std::vector<example*>& examples, std::vector<VW::string_view>&, std::vector<VW::string_view>&, io_buf&, std::vector<char> *io_lines_next_item)
{
