...
base_learner* csldf_setup(VW::setup_base_i& stack_builder)
{
  ...
  option_group_definition csldf_outer_options("[Reduction] Cost Sensitive One Against All with Label Dependent Features");
  csldf_outer_options
  ...
  option_group_definition csldf_inner_options("[Reduction] Cost Sensitive Weighted All-Pairs with Label Dependent Features");
