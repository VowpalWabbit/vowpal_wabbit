...
$VW --quiet -d regression_data_1.txt -f regression_data_1.model -c -k --passes 100 --holdout_off --predict_only_model
...
$VW --quiet -d regression_data_1.txt -f regression_data_no_constant.model -c -k --passes 100 --holdout_off --noconstant --predict_only_model
...
$VW --quiet -d regression_data_2.txt -f regression_data_ignore_linear.model -c -k --passes 100 --holdout_off --ignore_linear a --ignore_linear b --predict_only_model
...
$VW --quiet -d regression_data_2.txt -f regression_data_2.model -c -k --passes 100 --holdout_off --predict_only_model
...
$VW --quiet -d regression_data_3.txt -f regression_data_3.model -c -k --passes 100 --holdout_off -q ab --predict_only_model
...
$VW --quiet -d regression_data_4.txt -f regression_data_4.model -c -k --passes 2 --holdout_off --interactions abc --predict_only_model
...
$VW --quiet -d regression_data_4.txt -f regression_data_5.model -c -k --passes 2 --holdout_off --interactions abcd --predict_only_model
...
$VW --quiet -d regression_data_3.txt -f regression_data_6.model -c -k --passes 2 --holdout_off -q ab -b 33 --sparse_weights --predict_only_model
...
$VW --quiet -d regression_data_7.txt -f regression_data_7.model -c -k --passes 2 --holdout_off --predict_only_model
...
$VW --quiet -d multiclass_data_4.txt --csoaa_ldf m --csoaa_rank -q ab -k -c --holdout_off --passes 100 -f multiclass_data_4.model --predict_only_model
...
$VW --quiet -d multiclass_data_5.txt --csoaa_ldf m --csoaa_rank -k -c --holdout_off --passes 100 -f multiclass_data_5.model --predict_only_model
$VW --quiet -d multiclass_data_5.txt -i multiclass_data_5.model -t -p multiclass_data_5.pred

xxd -i multiclass_data_5.model >> $DATA_H
xxd -i multiclass_data_5.pred >> $DATA_H

# epsilon greedy
$VW --quiet -d cb_data_5.txt --cb_explore_adf --epsilon 0.3 -q ab -k -c --holdout_off --passes 100 -f cb_data_5.model --predict_only_model
...
# softmax
$VW --quiet -d cb_data_5.txt --cb_explore_adf --softmax --lambda -2 -q ab -k -c --holdout_off --passes 5 -f cb_data_6.model --predict_only_model
...
# bag
$VW --quiet -d cb_data_5.txt --cb_explore_adf --bag 3 -q ab -k -c --holdout_off --passes 100 -f cb_data_7.model --predict_only_model
...
# bag + epsilon greedy
$VW --quiet -d cb_data_5.txt --cb_explore_adf --bag 5 --epsilon 0.27 -q ab -k -c --holdout_off --passes 100 -f cb_data_8.model --predict_only_model
...
$VW --quiet -d cb_data_5.txt --cb_explore_adf --epsilon 0.3 --cb_type dr -q ab -k -c --holdout_off --passes 1000 -f cb_data_9.model --predict_only_model
