...
TEST(vowpal_wabbit_slim_tests, multiclass_data_4)
{
...
TEST(vowpal_wabbit_slim_tests, multiclass_data_5)
{
  vw_predict<sparse_parameters> vw;
...
TEST(vowpal_wabbit_slim_tests, interaction_num_bits_bug)
{
  std::ifstream input(
...
TEST(vowpal_wabbit_slim_tests, cb_data_epsilon_0_skype_jb)
{
...
TEST(cold_start_model_slim_tests, action_set_not_reordered)
{
