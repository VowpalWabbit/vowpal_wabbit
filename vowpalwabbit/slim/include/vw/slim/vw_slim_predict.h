  ...
  int predict(VW::example_predict& ex, float& score)
  {
    ...
    if (_contains_wildcard)
    {
      ...
      _generate_interactions.update_interactions_if_new_namespace_seen<
          VW::details::generate_namespace_combinations_with_repetition, false>(ex.ft_offset, _interactions, ex.indices);
      score = VW::inline_predict<W>(*_weights, false, _ignore_linear,
          _generate_interactions.get_generated_interactions(ex.ft_offset), _unused_extent_interactions,
