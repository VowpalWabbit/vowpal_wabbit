...
{
  if (is_learn)
    cb_explore_adf_base::learn(data, &cb_explore_adf_first::predict_or_learn_impl<true>,
        &cb_explore_adf_first::predict_or_learn_impl<false>, base, examples);
  else
    cb_explore_adf_base::predict(data, &cb_explore_adf_first::predict_or_learn_impl<false>, base, examples);
}
