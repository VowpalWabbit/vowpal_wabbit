...
namespace LEARNER
{
  ...
  struct learn_data {
    ...
    void (*update_f)(void* data, learner& base, example<void>&);
  };
  ...
  struct finish_example_data{
    void* data;
    learner* base;
    void (*finish_example_f)(vw&, void* data, example<void>&);
  };
  
  void generic_driver(vw* all);
  
  inline void generic_sl(void*, io_buf&, bool, bool) {}
  inline void generic_learner(void* data, learner& base, example<void>&) {}
...
public:
  ...
  inline void learn(example<void>& ec, size_t i=0) 
  { 
  ...
  inline void finish_example(vw& all, example<void>& ec) { finish_example_fd.finish_example_f(all, finish_example_fd.data, ec);}
  template<class T, void (*f)(vw& all, T&, example<void>&)>
