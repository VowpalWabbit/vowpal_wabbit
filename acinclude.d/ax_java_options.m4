...
AC_ARG_WITH(java-prefix,
            AS_HELP_STRING([--with-java-prefix=PREFIX],
              			   [Prefix where Java runtime is installed (optional)]))
AC_ARG_WITH(javac-flags,
            AS_HELP_STRING([--with-javac-flags=FLAGS],
            			   [Flags to pass to the Java compiler (optional)]))
AC_ARG_WITH(java-flags,
            AS_HELP_STRING([--with-java-flags=FLAGS],
            			   [Flags to pass to the Java VM (optional)]))
