...
# Parameters
k = 13330  # number of labels
kary_tree = 16
l = 1.0
passes = 3
b = 30
output_model = "amazonCat_model"

# Dataset filenames
train_data = "amazonCat_train.vw"
test_data = "amazonCat_test.vw"

print("Vowpal Wabbit PLT example on AmazonCat-13K dataset with {} labels".format(k))
