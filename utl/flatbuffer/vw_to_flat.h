...
private:
  ...
  flatbuffers::Offset<VW::parsers::flatbuffer::Namespace> create_namespace(features::const_iterator begin,
      features::const_iterator end, VW::namespace_index index, uint64_t hash);
  flatbuffers::Offset<VW::parsers::flatbuffer::Namespace> create_namespace_audit(features::audit_iterator begin,
      features::audit_iterator end, VW::namespace_index index, uint64_t hash);
};
