...
void check_interactions_match_exclusions(VW::reductions::automl::automl<
    interaction_config_manager<VW::reductions::automl::config_oracle<T>, VW::confidence_sequence::ConfidenceSequence>>* aml)
{
...
VW::reductions::automl::automl<
    interaction_config_manager<VW::reductions::automl::config_oracle<T>, VW::confidence_sequence::ConfidenceSequence>>*
...
BOOST_AUTO_TEST_CASE(one_diff_impl_unittest)
{
  ...
  test_hooks.emplace(1, [&](cb_sim& sim, VW::workspace& all, VW::multi_ex&) {
    ...
    std::vector<std::pair<aml_estimator<VW::confidence_sequence::ConfidenceSequence>, VW::confidence_sequence::ConfidenceSequence>> estimators;
    ...
    interaction_config_manager<config_oracle<one_diff_impl>, VW::confidence_sequence::ConfidenceSequence>::insert_starting_configuration(
    ...
    {
      interaction_config_manager<config_oracle<one_diff_impl>, VW::confidence_sequence::ConfidenceSequence>::apply_config_at_slot(estimators,
    ...
    // excl_2 is now champ
    interaction_config_manager<config_oracle<one_diff_impl>, VW::confidence_sequence::ConfidenceSequence>::apply_new_champ(
