...
void parse_label(label_parser& lp, parser* p, VW::string_view label, CONTCB::label& l)
{
...
BOOST_AUTO_TEST_CASE(contcb_parse_label)
{
  ...
  // standard case
  {
    auto label = scoped_calloc_or_throw<CONTCB::label>();
...
BOOST_AUTO_TEST_CASE(contcb_cache_label)
{
  ...
  auto uncached_label = scoped_calloc_or_throw<CONTCB::label>();
