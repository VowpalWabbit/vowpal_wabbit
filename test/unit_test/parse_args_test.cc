...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_no_opts_skip)
{
  ...
  merge_options_from_header_strings(strings, true, *opts, is_ccb_model, false);
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_no_opts_noskip)
{
  ...
  bool is_ccb_model = false;
  merge_options_from_header_strings(strings, false, *opts, is_ccb_model, false);
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_no_opts_skip_with_equals)
{
  const std::vector<std::string> strings;
  auto opts = VW::make_unique<options_boost_po>(std::vector<std::string>());

  bool is_ccb_model = false;
  merge_options_from_header_strings(strings, true, *opts, is_ccb_model, true);
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_no_opts_noskip_with_equals)
{
  const std::vector<std::string> strings;
  auto opts = VW::make_unique<options_boost_po>(std::vector<std::string>());

  bool is_ccb_model = false;
  merge_options_from_header_strings(strings, false, *opts, is_ccb_model, true);
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_bool_opt_skip_with_equals)
{
  const std::vector<std::string> strings{"--bool_opt"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_bool_opt_noskip_with_equals)
{
  const std::vector<std::string> strings{"--bool_opt"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_int_opt_skip_with_equals)
{
  const std::vector<std::string> strings{"--int_opt=3"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_int_opt_noskip_with_equals)
{
  const std::vector<std::string> strings{"--int_opt=3"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_bool_int_opt_skip_with_equals)
{
  const std::vector<std::string> strings{"--bool_opt", "--int_opt=3"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_bool_int_opt_noskip_with_equals)
{
  const std::vector<std::string> strings{"--bool_opt", "--int_opt=3"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_int_bool_opt_skip_with_equals)
{
  const std::vector<std::string> strings{"--int_opt=3", "--bool_opt"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_int_bool_opt_noskip_with_equals)
{
  const std::vector<std::string> strings{"--int_opt=3", "--bool_opt"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_bool_int_interaction_bool_int_opt_skip_with_equals)
{
  const std::vector<std::string> strings{
      "--bool_opt1", "--int_opt1=3", "--interactions=::", "--bool_opt2", "--int_opt2=4"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_bool_int_interaction_bool_int_opt_noskip_with_equals)
{
  const std::vector<std::string> strings{
      "--bool_opt1", "--int_opt1=3", "--interactions=::", "--bool_opt2", "--int_opt2=4"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_bool_int_interaction_int_bool_opt_skip_with_equals)
{
  const std::vector<std::string> strings{
      "--bool_opt1", "--int_opt1=3", "--interactions=::", "--int_opt2=4", "--bool_opt2"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_bool_int_interaction_int_bool_opt_noskip_with_equals)
{
  const std::vector<std::string> strings{
      "--bool_opt1", "--int_opt1=3", "--interactions=::", "--int_opt2=4", "--bool_opt2"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_int_bool_interaction_bool_int_opt_skip_with_equals)
{
  const std::vector<std::string> strings{
      "--int_opt1=3", "--bool_opt1", "--interactions=::", "--bool_opt2", "--int_opt2=4"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_int_bool_interaction_bool_int_opt_noskip_with_equals)
{
  const std::vector<std::string> strings{
      "--int_opt1=3", "--bool_opt1", "--interactions=::", "--bool_opt2", "--int_opt2=4"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_int_bool_interaction_int_bool_opt_skip_with_equals)
{
  const std::vector<std::string> strings{
      "--int_opt1=3", "--bool_opt1", "--interactions=::", "--int_opt2=4", "--bool_opt2"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_from_header_strings_int_bool_interaction_int_bool_opt_noskip_with_equals)
{
  const std::vector<std::string> strings{
      "--int_opt1=3", "--bool_opt1", "--interactions=::", "--int_opt2=4", "--bool_opt2"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_options_from_ccb_header_with_equals)
{
  const std::vector<std::string> strings{"--dsjson", "--epsilon=0.2", "--ccb_explore_adf"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
...
BOOST_AUTO_TEST_CASE(merge_option_from_cb_header_with_equals)
{
  const std::vector<std::string> strings{"--dsjson", "--epsilon=0.2", "--cb_explore_adf"};
  auto opts = VW::make_unique<VW::config::options_boost_po>(std::vector<std::string>());
