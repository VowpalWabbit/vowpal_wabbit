  ...
  std::string json_text = R"(
{
  ...
  BOOST_CHECK_EQUAL(examples[1]->l.slates.type, slates::example_type::action);
  BOOST_CHECK_EQUAL(examples[2]->l.slates.type, slates::example_type::action);
  BOOST_CHECK_EQUAL(examples[3]->l.slates.type, slates::example_type::action);
  BOOST_CHECK_EQUAL(examples[4]->l.slates.type, slates::example_type::action);
  BOOST_CHECK_EQUAL(examples[5]->l.slates.type, slates::example_type::action);
  BOOST_CHECK_EQUAL(examples[6]->l.slates.type, slates::example_type::slot);
  BOOST_CHECK_EQUAL(examples[7]->l.slates.type, slates::example_type::slot);
