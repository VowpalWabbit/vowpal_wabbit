...
BOOST_AUTO_TEST_CASE(pow10_tests)
{
  ...
  BOOST_CHECK(are_same(VW::fast_pow10(-127), std::pow(10, -127)));
  BOOST_CHECK(are_same(VW::fast_pow10(-46), std::pow(10, -46)));
  BOOST_CHECK(are_same(VW::fast_pow10(-45), std::pow(10, -45)));
  BOOST_CHECK(are_same(VW::fast_pow10(-44), std::pow(10, -44)));
  BOOST_CHECK(are_same(VW::fast_pow10(-40), std::pow(10, -40)));
  BOOST_CHECK(are_same(VW::fast_pow10(-38), std::pow(10, -38)));
  BOOST_CHECK(are_same(VW::fast_pow10(-37), std::pow(10, -37)));
  BOOST_CHECK(are_same(VW::fast_pow10(-10), std::pow(10, -10)));
  BOOST_CHECK(are_same(VW::fast_pow10(-5), std::pow(10, -5)));
